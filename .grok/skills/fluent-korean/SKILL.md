---
name: fluent-korean
description: 의미가 명확한 한국어 문장을 출력하게 하는 지침입니다. 조사·어미 탈락, 전보체 명사열, 비유 어휘 치환을 막고 완성된 한국어 문장을 쓰게 한다. Use whenever producing Korean text, writing Korean documents, generating a Korean dataset, or polishing Korean drafts. Follow the original fluent-korean output-style verbatim — do not replace it with a different writing system.
---

# fluent-korean

This is the Grok-loadable form of the `fluent-korean` Claude Code output-style.
**Follow `output-styles/fluent-korean.md` verbatim.** Do not summarize the
clauses. Do not substitute a different Korean writing guide.

Canonical source in this workspace:

- `fluent-korean/plugins/fluent-korean/output-styles/fluent-korean.md`
- local copy: `output-styles/fluent-korean.md`

A non-coding variant lives at `output-styles/fluent-korean-not-coding.md`.
The skill name remains `fluent-korean`.

The original file is reproduced below and is the rule set.
